...
int main (int argc,char* argv[]){
  ...
  ofstream Risultati;
  Risultati.open("../Distanze_quadrato.dat");
  
  Salesman Walker(30,1, rank); //30 citta e una poplazione di un elemento
  Walker.Square(); //iniziliazzazione citta
  Walker.SetNumberMutation(1); //1 permutazione di coppia ad ogni passo
   ...
   //Il nodo zero invia a tutti i nodi l'indice del miglior nodo che ha identificato 
    ...
    if( rank==index_minimum){
              Walker.PrintPath("../BestPath_quadrato.dat");
    }
