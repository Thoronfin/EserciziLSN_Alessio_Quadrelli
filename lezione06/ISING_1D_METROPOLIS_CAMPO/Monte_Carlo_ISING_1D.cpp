...
//  cout << "Acceptance rate " << accepted/attempted << endl << endl;
  ...
  stima_c = pow(beta,2) * (stima_u2-pow(stima_u,2)); //Colore specifico in unità naturali
  glob_av[ic]  += stima_c;
  ...
  */
  if(iblk == nblk){
    /*
    ResultsU.open("../ene_campo.result.0",ios::app);
    ...
    */
    ResultsM.open("../mag_campo.result.Gibbs",ios::app);
